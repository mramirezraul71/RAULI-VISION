...
func defaultChannels() []channel {
	channels := []channel{
		...
		},
		{
			...
			FallbackURL: "https://www.youtube.com/@rtve/live",
			StreamM3U8:  "https://rtvelivestream-rtveplayplus.rtve.es/rtvesec/int/tvei_eu_main_1080.m3u8",
			CubaReady:   true,
			Priority:    2,
		...
		},
		{
			...
			FallbackURL: "https://www.youtube.com/@CanalCaribeCuba/live",
			CubaReady:   true,
			Priority:    3,
		...
		},
		{
			...
			FallbackURL: "https://www.youtube.com/results?search_query=cubavision+internacional+en+vivo",
			CubaReady:   true,
			Priority:    4,
		...
		},
		{
			...
			StreamM3U8:  "https://mblesmain01.telesur.ultrabase.net/mbliveMain/hd/playlist.m3u8",
			CubaReady:   true,
			Priority:    5,
		...
		},
		{
			...
			StreamM3U8:  "https://dwamdstream104.akamaized.net/hls/live/2015530/dwstream104/master.m3u8",
			CubaReady:   true,
			Priority:    6,
		...
		},
		{
			...
			StreamM3U8:  "https://live.france24.com/hls/live/2037220-b/F24_ES_HI_HLS/master_5000.m3u8",
			CubaReady:   true,
			Priority:    7,
